...
from .channels import channels_2and5, channels_2ghz, channels_5ghz, channels_60ghz
...
schema = {
    ...
    "definitions": {
        ...
        "radio_ad_channel_width": {
            "properties": {"channel_width": {"enum": [2160]}}
        },
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "auto execute": {
                        "type": "boolean",
                        "title": "auto execute",
                        "description": "starts a file with the executable Bit",
                        "default": True,
                        "format": "checkbox",
                        "propertyOrder": 3,
                    },
